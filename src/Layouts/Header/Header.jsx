...
import { MenuDialog } from "../../components/MenuDialog/MenuDialog.jsx";
...
export function Header() {
  ...
  const { openModal: openNavbar, closeModal: closeNavbar } = useModal({
    dialogRef: navRef,
    enabled: isMobile,
  });
  ...
  return (
    <header className="header">
      <div className="header-container">
        ...
        {!isMobile && (
          <>
            <a className="githubHeader" href="https://github.com/hesedcrz19/FakeStore-Javascript" target="_blank">
      ...
      <MenuDialog ref={navRef} closeModal={closeNavbar} />
    </header>
  );
}
